<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
    <?php $eval = query_user_eval($conn, $cNum, $cDep, $cSem, $instr_email); ?>
        ...
        <div class="card-body">
            ...
            <div class="input-group rounded">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <textarea name="p_review" class="form-control <?php echo $pReviewErr ? 'is-invalid' : null; ?>" aria-label="Instructor Review"><?php echo $eval['review']; ?></textarea>
                    <div class="invalid-feedback">
                        <?php echo $pReviewErr; ?>
                    </div>
                </div>
