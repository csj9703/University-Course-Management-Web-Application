            ...
            <div class="input-group rounded">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <select class="form-select <?php echo $cWLErr ? 'is-invalid' : null; ?>" name="c_workload" id="cWLSelect">
                        <option selected>Choose course workload</option>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <textarea name="c_review" class="form-control <?php echo $cReviewErr ? 'is-invalid' : null; ?>" aria-label="Course Review"></textarea>
                    <div class="invalid-feedback">
                        <?php echo $cReviewErr; ?>
                    </div>
                </div>
