            ...
            <div class="input-group rounded">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <select class="form-select <?php echo $cSemErr ? 'is-invalid' : null; ?>" name="course_semester" id="cSemesterSelect">
                        <option selected><?php echo $course_info['semester'] ?></option>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <select class="form-select <?php echo $cDepErr ? 'is-invalid' : null; ?>" name="course_department" id="cDepartSelect">
                        <option selected value="<?php echo "{$course_info['dep_name']},{$course_info['dep_title']}"; ?>"><?php echo "{$course_info['dep_name']} - {$course_info['dep_title']}" ?></option>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <input type="text" value=<?php echo $course_info['c_num']; ?> name="course_number" class="form-control <?php echo $cNumErr ? 'is-invalid' : null; ?>" placeholder="Enter the course number">
                    <div class="invalid-feedback">
                        <?php echo $cNumErr; ?>
                    </div>
                </div>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <input type="text" value="<?php echo $course_info['course_name'] ?>" name="course_name" class="form-control <?php echo $cNameErr ? 'is-invalid' : null; ?>" placeholder="Enter the course name">
                    <div class="invalid-feedback">
                        <?php echo $cNameErr; ?>
                    </div>
                </div>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <input type="text" value=<?php echo $course_info['credits'] ?> name="course_credits" class="form-control <?php echo $cCredErr ? 'is-invalid' : null; ?>" placeholder="Enter course credits">
                    <div class="invalid-feedback">
                        <?php echo $cCredErr; ?>
                    </div>
                </div>
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <textarea name="course_description" class="form-control <?php echo $cDesErr ? 'is-invalid' : null; ?>" aria-label="Course Description"><?php echo $course_info['descript'] ?></textarea>
                    <div class="invalid-feedback">
                        <?php echo $cDesErr; ?>
                    </div>
                </div>
                ...
                <div class="card card-body collapse" aria-expanded="false" id="antiReqCollapse">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" value="<?php echo $course_info['antirequisites'] ?>" class="form-control" name="antiReq" placeholder="Enter antirequisites...">
                    </div>
                </div>
                ...
                <div class="card card-body collapse" aria-expanded="false" id="preReqCollapse">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" value="<?php echo $course_info['prerequisites'] ?>" class="form-control" name="preReq" placeholder="Enter prerequisites...">
                    </div>
                </div>
                <div class="input-group mt-3 mb-3">
